        ...
        <div class="submitbox" id="submitpost">
            ...
            <div class="disable-notification-checkbox" style="padding: 5px 0 10px 0;">
                <div class="bnfw-help-tip-container">
                    ...
                    <div class="bnfw-help-tip">
                        <p><?php esc_html_e('Use this to enable or disable notifications. If you want to disable a default WordPress notification, just create it on the left, then disable it here.', 'bnfw'); ?></p>
                    </div>
                ...
                <?php if ('publish' == $post->post_status) { ?>
                    <div class="bnfw-help-tip-container">
                        ...
                        <div class="bnfw-help-tip">
                            <p><?php esc_html_e('This will send you (the currently logged in user) a notification so that you can check for any issues with formatting – it’s doesn\'t mean that a notification will send correctly in the future. You can read about how to improve email delivery', 'bnfw'); ?>
                                <a href="https://betternotificationsforwp.com/documentation/getting-started/how-to-improve-email-delivery/" target="_blank"><?php esc_html_e('here', 'bnfw'); ?></a><?php esc_html_e('. Shortcodes will not be replaced with content.', 'bnfw'); ?>
                            </p>
                        </div>
                    </div>
                <?php } ?>
