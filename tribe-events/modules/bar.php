...
<?php do_action('tribe_events_bar_before_template') ?>
    <div id="tribe-events-bar">
        <?php do_action('wms_filter_bar_inject'); ?>
        <form autocomplete="off" id="tribe-bar-form" class="tribe-clearfix" name="tribe-bar-form" method="post" action="<?php echo esc_attr($current_url); ?>">

            <input autocomplete="false" name="hidden" id="hidden" type="text" style="display:none;">
            <label for="hidden">Tribe Bar Hidden Input</label>
            <!-- Mobile Filters Toggle -->

            <button id="tribe-bar-collapse-toggle" <?php if (count($views) == 1) { ?> class="tribe-bar-collapse-toggle-full-width"<?php } ?>>
                <?php printf(esc_html__('Find', 'the-events-calendar'), tribe_get_event_label_plural()); ?>
            ...
            <?php if (count($views) > 1) { ?>
                <div id="tribe-bar-views">
                    <div class="tribe-bar-views-inner tribe-clearfix">
                        ...
                        <label for="tribe-bar-view"><?php esc_html_e('View As', 'the-events-calendar'); ?></label>
                        <select class="tribe-bar-views-select tribe-no-param" name="tribe-bar-view" id="tribe-bar-view">
